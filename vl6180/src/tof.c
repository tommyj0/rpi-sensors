  ...
  if (setup == 1)
    {
      ...
      write_byte (handle, 0x002e, 0x01); // perform a single temperature
                                         // calibratio of the ranging sensor
      write_byte (
          handle, 0x001b,
          0x09); // Set default ranging inter-measurement period to 100ms
      write_byte (handle, 0x003e,
